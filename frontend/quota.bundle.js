...
function UsageMeter({
  ...
  }, "Today's usage"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "JetBrains Mono, monospace",
      fontSize: 12,
      color: empty ? "var(--v-false-fg)" : TN.ink
    }
  }, used, " / ", limit)), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 8,
      background: TN.borderSoft,
  ...
  }, tier_name || tier, " plan \xB7 resets ", new Date(quota.resets_at).toLocaleString("en-US", {
    timeZone: "UTC",
    month: "short",
    day: "numeric",
    hour: "2-digit",
...
function QuotaExceededBanner({
  ...
  }, "You've used all ", quota.limit, " fact-checks on your ", quota.tier_name || quota.tier, " plan today."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: "Inter, sans-serif",
      fontSize: 13,
      color: TN.ink2,
  ...
  }, "Upgrade for a higher daily limit, or wait until midnight UTC."), /*#__PURE__*/React.createElement("button", {
    type: "button",
